const Verification_Template = `
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              <p>Hello,</p>
              <p>Please enter the code to verify your mail:</p>
              <span class="verification-code">{verificationCode}</span>
              <p>If you did not create an account, no further action is required. If you have any questions, feel free to contact our support team.</p>
          </div>
          <div class="footer">
              <p>&copy; ${new Date().getFullYear()} NITP Free Resources. All rights reserved.</p>
          </div>
      </div>
  </body>
  </html>
...
const Welcome_Template = `
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Welcome to Free Resources Platform of NIT Patna</title>
      <style>
          body {
              font-family: Arial, sans-serif;
              margin: 0;
...
module.exports = { Verification_Template, Welcome_Template }
